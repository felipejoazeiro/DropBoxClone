class DropBoxController {
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAzpUrbyAZicWU4dkYYy6DxuNbA3mCcf1M",
            authDomain: "dropbox-clone-49e62.firebaseapp.com",
            databaseURL: "https://dropbox-clone-49e62-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-49e62",
            storageBucket: "dropbox-clone-49e62.appspot.com",
            messagingSenderId: "821829234547",
            appId: "1:821829234547:web:fa703ced7ac725a5569f06",
            measurementId: "G-S6VJLJL6E0"
        };
        // Initialize Firebase
    ...
    initEventsLi(li){
        li.addEventListener('click', e=>{
            ...
            this.listFilesEl.dispatchEvent(onselectionchange)
